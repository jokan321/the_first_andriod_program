package com.example.touristsights.fragment
...
import com.example.touristsights.adapter.SightAdapter
import com.example.touristsights.databinding.FragmentListBinding
import com.example.touristsights.model.getSights
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.root.apply {
            ...
            adapter = SightAdapter(context, getSights(resources)).apply {
                setOnItemClickListener { position: Int -> fragmentManager?.let {
